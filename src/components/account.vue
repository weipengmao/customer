  ...
  methods: {
    ...
    changeStyle(a) {
      if (this.flag) {
        this.$refs.changeSty[
          a
        ].src = require("../common/image/heart_after.png");
        this.flag = false;
      } else {
        this.$refs.changeSty[
          a
        ].src = require("../common/image/heart_before.png");
        this.flag = true;
      }
    },
    changeBeat(a) {
      if (this.flagBeat) {
        this.$refs.changeBeat[
          a
        ].src = require("../common/image/heart_after.png");
        this.flagBeat = false;
      } else {
        ...
        CustomerHttp.httpPost(`api/qx`, {
          ...
          function(val) {
            ...
            if (val.data.flag != 90010098) {
              ...
              _that.$nextTick(() => {
                if (_that.questDetail == "") {
                  _that.$refs.testIndex[
                    _that.idNum
                  ].parentNode.parentNode.style.width =
                    "100%";
                  _that.$refs.testIndex[
                    _that.idNum
                  ].parentNode.lastChild.innerHTML =
                    "";
                  _that.$refs.testIndex[_that.idNum].innerHTML =
                    "没能理解您的意思哦，换一种问法试试";
                } else {
                  _that.$refs.testIndex[_that.idNum].innerHTML = `${
                    _that.robotAnswer
            ...
            if (val.data.flag != 90010098) {
              ...
              _that.$nextTick(() => {
                ...
                if (val.data.rows) {
                  ...
                  if (
                    _that.$refs.testIndexTwo[_that.idNumTwo].parentNode
                      .lastChild.innerHTML
                  ) {
                    _that.$refs.testIndexTwo[
                      _that.idNumTwo
            ...
            _that.$nextTick(() => {
              if (_that.questDetail == "") {
                _that.$refs.testIndexTwo[
                  ...
                  "100%";
                if (
                  _that.$refs.testIndexTwo[_that.idNumTwo].parentNode.lastChild
                    .innerHTML
                ) {
                  _that.$refs.testIndexTwo[
                    _that.idNumTwo
      ...
      this.$confirm("是否确定转到人工客服", "提示", {
        ...
        .then(() => {
          if (openID) {
            ...
            setTimeout(() => {
              location.href =
                "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7e88240ec21db9f6&redirect_uri=http://robot.health-vi.com/customer/auth.html?redirect_uri=http://robot.health-vi.com/customer&response_type=code&scope=snsapi_base&state=47c7be842c4e790f&component_appid=wxb98cc920f74c1f5f#wechat_redirect";
            }, 1000);
          }
        })
        .catch(() => {
